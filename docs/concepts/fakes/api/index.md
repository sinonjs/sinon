---
title: Fakes API
description: Create and configure fake functions with returns, throws, yields, and async behavior.
---
...
Unlike [`sinon.spy`][spies] and [`sinon.stub`][stubs] methods, the `sinon.fake` API knows only how to _create_ fakes, and doesn't concern itself with plugging them into the system under test.
