---
title: SpyCall API
description: Access call details like arguments, return value, this context, and exceptions for each spy invocation.
---
...
- [`notCalledWith`](./not-called-with)
- [`notCalledWithMatch`](./not-called-with-match)
- [`returned`](./returned)
- [`threw`](./threw)
