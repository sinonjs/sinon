...
description: Built-in assertion methods for verifying spy, stub, and mock behavior. Provides detailed error messages on failure.
---
...
- [`calledOnceWithMatch`][calledOnceWithMatch]
...
- [`fail`][fail]
- [`match`][match]
- [`neverCalledWith`][neverCalledWith]
- [`neverCalledWithMatch`][neverCalledWithMatch]
- [`notCalled`][notCalled]
- [`pass`][pass]
- [`threw`][threw]
...
[calledOnceWithMatch]: ./called-once-with-match
