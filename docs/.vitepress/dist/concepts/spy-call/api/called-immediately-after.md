---
url: /concepts/spy-call/api/called-immediately-after.md
description: >-
  Returns `true`, when the spy call occurred after another call, and no calls to
  any spy occurred in between.
---
