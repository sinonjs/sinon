---
url: /concepts/spy-call/api/called-with-exactly.md
description: >-
  Returns `true`, when the spy call received provided arguments in exact same
  order and received no other arguments.
---
