---
url: /concepts/mocks/error-handling.md
description: >-
  Mocks throw errors when expectations aren't met or when used incorrectly.
  Learn about common mock errors and how to fix them.
---
