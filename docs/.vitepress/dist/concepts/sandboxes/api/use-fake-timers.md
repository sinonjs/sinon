---
url: /concepts/sandboxes/api/use-fake-timers.md
description: >-
  Fakes the native timers and binds the `clock` object to the sandbox so it is
  restored when calling `sandbox.restore()`.
---
