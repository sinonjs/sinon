---
url: /concepts/sandboxes/api.md
description: >-
  Since `sinon@5.0.0`, the `sinon` object is a default sandbox. Unless you have
  a very advanced setup or need a special configuration, you probably want to
  only use that one.
---
...
[create-stub-instance]: ./create-stub-instance
...
[replace-getter]: ./replace-getter

[replace-setter]: ./replace-setter
