---
url: /concepts/stubs/api/call-through-with-new.md
description: >-
  Causes the original method wrapped into the stub to be called using the `new`
  operator, when none of the conditional stubs are matched.
---
