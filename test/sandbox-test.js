...
var fakeXhr = require("../src/sinon/util/fake_xml_http_request");
var fakeServerWithClock = require("../src/sinon/util/fake_server_with_clock");
var fakeServer = require("../src/sinon/util/fake_server");
...
var sinonConfig = require("../src/sinon/util/core/get-config");
var sinonMatch = require("../src/sinon/match");
var sinonAssert = require("../src/sinon/assert");
var sinonClock = require("../src/sinon/util/fake_timers");
