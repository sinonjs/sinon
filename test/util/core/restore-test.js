...
describe("util/core/restore", function () {
    it("restores all methods of supplied object", function () {
        var methodA = function () { return; };
        var methodB = function () { return; };
        var nonEnumerableMethod = function () { return; };
    ...
    it("only restores restorable methods", function () {
        var stubbedMethod = function () { return; };
        var vanillaMethod = function () { return; };
