...
describe("stub", function () {
    ...
    it("throws when trying to stub an ES module namespace object", function () {
        const object = {};
    ...
    describe("everything", function () {
        ...
        sharedSpyStubEverythingTests(createStub);
    ...
    describe(".withArgs", function () {
        ...
        it("inherits promise libraries into filtered fakes", function () {
            const stub = createStub();
            ...
            const filtered = stub.withArgs("value");

            assert.same(
                filtered.defaultBehavior.promiseLibrary,
                promiseLibrary,
            );
        });
    });

    describe("descriptor validation", function () {
        it("throws for non-writable own data properties", function () {
            const object = {};
        ...
        it("restores inherited properties by deleting the own stub", function () {
            const prototype = {
                prop: function prop() {
                    return "original";
                },
            ...
            const stub = createStub(object, "prop");
