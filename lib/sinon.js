...
exports.extend = deprecated.wrap(require("./sinon/util/core/extend"), deprecated.defaultMsg("extend"));
exports.typeOf = deprecated.wrap(require("./sinon/util/core/typeOf"), deprecated.defaultMsg("typeOf"));
