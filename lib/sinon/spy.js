...
(function (sinon) {
    ...
    function spy(object, property, customSpy) {
        ...
        var method;
        // custrom spy is defined
        if (customSpy) {
            // if custom spy if function use it, otherwise create empty function
            method = typeof customSpy == 'function' ? customSpy : function(){};
