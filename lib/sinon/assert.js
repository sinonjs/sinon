...
(function (sinon) {
  ...
  assert = {
    ...
    notCalled: function assertNotCalled(method) {
      ...
      if (method.called) {
        failAssertion(this, "fake was called " + method.callCount + " times");
      }
    },
  ...
  mirrorAssertion("calledOnce", "%0 was not called once");
  mirrorAssertion("calledTwice", "%0 was not called twice");
  mirrorAssertion("calledThrice", "%0 was not called thrice");
