...
const { slice: arraySlice, concat, forEach, join, splice } = commons.prototypes.array;
const { slice: stringSlice } = commons.prototypes.string;
...
function createAssertObject(opts) {
    ...
    const assert = {
        ...
        callOrder: function assertCallOrder() {
            ...
            if (!commons.calledInOrder(arguments)) {
                try {
                    ...
                    actual = join(commons.orderByFirstCall(calls), ", ");
                } catch (e) {
        ...
        callCount: function assertCallCount(method, count) {
            ...
            if (typeof count !== "number") {
                msg =
                    `expected ${util.inspect(count)} to be a number ` +
        ...
        match: function match(actual, expectation) {
            const matcher = samsam.createMatcher(expectation);
    ...
    function failAssertion(object, msg) {
        const obj = object || commons.global;
...
const assert = createAssertObject();
assert.createAssertObject = createAssertObject;

exports.createAssertObject = createAssertObject;
