...
var functionToString = require('./util/core/function-to-string.js');
...
var spyFormatters = require('./spy-formatters.js');

const { push, forEach, slice } = commons.prototypes.array;
