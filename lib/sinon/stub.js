    ...
    function stub(object, property, func) {
        ...
        if (!property && !!object && typeof object == "object") {
            for (var prop in object) {
                var isOwnProperty = object.hasOwnProperty(prop);
                var isPrototypeProperty = object.constructor.prototype[prop];
                var isFunction = typeof object[prop] == "function";

                if (isFunction && (isOwnProperty || isPrototypeProperty)) {
                    stub(object, prop);
                }
            }
