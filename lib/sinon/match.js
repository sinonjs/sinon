...
var functionName = require("./util/functionName");
    ...
    switch (type) {
        ...
        case "function":
            ...
            if (message) {
                ...
                m.message = "match(" + functionName(expectation) + ")";
            }
            break;
        default:
            m.test = function (actual) {
    ...
    return function (property, value) {
        ...
        return match(function (actual) {
            ...
            if (match.isMatcher(value)) {
                return value.test(actual[property]);
            }

            return deepEqual(value, actual[property]);
        }, message);
    };
}
