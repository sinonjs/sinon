...
var proxyInvoke__default = /*#__PURE__*/_interopDefault(proxyInvoke);
var proxyCall__default = /*#__PURE__*/_interopDefault(proxyCall);
var timesInWords__default = /*#__PURE__*/_interopDefault(timesInWords);
...
function callCountInWords(callCount) {
    ...
    return `called ${timesInWords__default.default(callCount)}`;
}
...
function expectedCallCountInWords(expectation) {
    ...
    if (typeof min === "number" && typeof max === "number") {
        let str = timesInWords__default.default(min);

        if (min !== max) {
            str = `at least ${str} and at most ${timesInWords__default.default(max)}`;
        }
    ...
    if (typeof min === "number") {
        return `at least ${timesInWords__default.default(min)}`;
    }

    return `at most ${timesInWords__default.default(max)}`;
}
...
const mockExpectation = {
    ...
    invoke: function invoke(func, thisValue, args) {
        ...
        return proxyInvoke__default.default.apply(this, arguments);
    },
    ...
    verifyCallAllowed: function verifyCallAllowed(thisValue, args) {
        ...
        if (receivedMaxCalls(this)) {
            ...
            mockExpectation.fail(
                `${this.method} already called ${timesInWords__default.default(this.maxCalls)}`,
            );
        }
    ...
    toString: function () {
        ...
        const callStr = proxyCall__default.default.toString.call({
    ...
    pass: function pass(message) {
        sinonAssert__default.default.pass(message);
    },
