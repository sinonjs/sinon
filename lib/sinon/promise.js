...
var isRestorable = require('./util/core/is-restorable.js');

function _interopDefault (e) { return e && e.__esModule ? e : { default: e }; }

var sinonFake__default = /*#__PURE__*/_interopDefault(sinonFake);
var isRestorable__default = /*#__PURE__*/_interopDefault(isRestorable);
...
function getFakeExecutor(executor) {
    if (isRestorable__default.default(executor)) {
        return executor;
    }
    if (executor) {
        return sinonFake__default.default(executor);
    }
    return sinonFake__default.default();
}
