...
var mockExpectation = require('./mock-expectation.js');
...
const { concat, filter, forEach, every, join, push, slice, unshift } = commons.prototypes.array;
...
function arrayEquals(arr1, arr2, compareLength) {
    ...
    return every(arr1, function (element, i) {
        return samsam.deepEqual(arr2[i], element);
    });
}
