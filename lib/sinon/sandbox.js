...
function Sandbox(opts = {}) {
    ...
    sandbox.assert = assert.default.createAssertObject(assertOptions);
    ...
    sandbox.fake = function fake$1(f) {
        const s = fake.apply(fake, arguments);
    ...
    forEach(Object.keys(fake), function (key) {
        const fakeBehavior = fake[key];
