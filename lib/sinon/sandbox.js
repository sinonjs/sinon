...
function Sandbox() {
    ...
    sandbox.replace = function replace(object, property, fake) {
        ...
        if (typeof fake === "undefined") {
            throw new TypeError("Expected fake argument to be defined");
        }
        ...
        object[property] = fake;
    };

    sandbox.replaceGetter = function replaceGetter(object, property, fake) {
        var descriptor = Object.getOwnPropertyDescriptor(object, property);
    ...
    sandbox.replaceSetter = function replaceSetter(object, property, fake) {
        var descriptor = Object.getOwnPropertyDescriptor(object, property);
