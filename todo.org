...
* Fake timers [0/3]
** TODO Fake Date by default
** TODO Timers should be executed in the order they are scheduled
** TODO Ticking the clock should keep Date up to date on every timer
