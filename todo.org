...
** TODO tick: Don't recalculate starting point to avoid dropping timers
** TODO tick: Don't fire any callbacks until all timers have been figured out to ensure call order
